...
const functionName = `create${name
  .split("-")
...
console.log(
  `2. Add { name: '${name}', mountPath: '/api', createRouter: ${functionName} } to featureRegistry`,
);
console.log(
  "3. Add tests in tests/*.test.js before adding production behavior",
);
